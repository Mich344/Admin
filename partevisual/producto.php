...
<body>
	...
	<?php 
		...
		$queryproducto="SELECT Id,nombre,precio,cantidad, talla, descripcion, imagen FROM productos WHERE Id='$Id';";
				...
				<div class="panel-group collpse" id="accordion" role="tablist" aria-multiselectable="true">
					...
					<div class="panel panel-default wow fadeInUp animated" data-wow-delay=".8s">
						...
						<div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
							<div class="panel-body">
								Para cualquier duda puedes contactarnos a nuestro correo o a nuestro número. Dirigete al siguiente link para que puedas accerder a ellos <a href="productos.php"> este link 
							</div>
						</div>
					</div>
				</div>
