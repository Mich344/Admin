		...
		<div class="top-header navbar navbar-default"><!--header-one-->
			...
			<div class="container">				
				<div class="nav navbar-nav wow fadeInLeft animated" data-wow-delay=".5s">
					<p><strong> <a href="sda.php" style = "color: #B2051F ">SPORTS</a>WEARLINE</strong>|<a href="registro.php"><strong>Registrarse</strong> </a> O <a href="ingreso.php"><strong>Ingresar </strong></a></p>
				</div>
			...
			<div class="container">
				...
				<div class="nav navbar-nav navbar-right header-two-right">
					<div class="header-right my-account">
						<a href="contactanos.php"><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span> CONTÁCTANOS</a>
	...
	<div class="cart-items">
		<div class="container">
			...
			<div class="cart-header wow fadeInUp animated" data-wow-delay=".5s">
				...
				<div class="cart-sec simpleCart_shelfItem">
					<div class="cart-item cyc">
						<a href="producto.php"><img src="images/3p.png" class="img-responsive" alt=""></a>
					</div>
					<div class="cart-item-info">
						<h4><a href="producto.php"> Buzo con capucha Badge of Sport Felpa </a></h4>
						<ul class="qty">
			...
			<div class="cart-header1 wow fadeInUp animated" data-wow-delay=".7s">
				...
				<div class="cart-sec simpleCart_shelfItem">
					<div class="cart-item cyc">
						<a href="producto.php"><img src="images/1p.png" class="img-responsive" alt=""></a>
					</div>
					<div class="cart-item-info">
						<h4><a href="producto.php"> camiseta 3 rayas Essentials. </a></h4>
						<ul class="qty">
			...
			<div class="cart-header wow fadeInUp animated" data-wow-delay=".5s">
				...
				<div class="cart-sec simpleCart_shelfItem">
					<div class="cart-item cyc">
						<a href="producto.php"><img src="images/2p.png" class="img-responsive" alt=""></a>
					</div>
					<div class="cart-item-info">
						<h4><a href="producto.php"> Buzo con capucha Badge of Sport Felpa </a></h4>
						<ul class="qty">
