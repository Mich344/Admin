  ...
  <div class="login-page">
    ...
    <div class="widget-shadow">
      <div class="login-top wow fadeInUp animated" data-wow-delay=".7s">
        <h4><span id="signo">¡</span><b>Bienvenido a SportsWearLine</b><span id="signo">!</span> <br> <span id="signo">¿</span><b>No eres usuario</b><span id="signo">?</span> <a href="registro.php"> Registrate Ahora</a> </h4>
      </div>
