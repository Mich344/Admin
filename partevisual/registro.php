  ...
  <div class="login-page">
    ...
    <div class="widget-shadow">
      <div class="login-top wow fadeInUp animated" data-wow-delay=".7s">
        <h4><span id="signo">¡</span><b>Bienvenido a SportsWearLine</b><span id="signo">!</span> <br> <span id="signo">¿</span><b>Ya eres miebro</b><span id="signo">?</span> <a href="ingreso.php"> Ingresa ahora</a> </h4>
      </div>
      <div class="login-body wow fadeInUp animated" data-wow-delay=".7s">
        ...
        ?>
            <div class="alert alert-registro exitoso" role="alert">
              <strong>registro exitoso</strong> <a href="ingreso.php">Ingresar</a>
            </div>
          <?php
          } else {
          ?>
