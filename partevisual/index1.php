      ...
      <div class="container">
        ...
        <div class="nav navbar-nav navbar-right header-two-right">
          <div class="header-right my-account">
            <a href="contactanos.php"><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span><strong>CONTÁCTANOS</strong></a>

          </div>
          <div class="header-right cart">
            <a href="#"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span></a>
            <h4><a href="carrito.php">
      ...
      <div class="new-info">
        ...
        /*for ($row=1;$row <4 ; $row++) { 
						...
						<div class="col-md-3 gallery-grid gallery-grid2 wow flipInY animated" data-wow-delay=".9s">
							<a href="producto.php" title="Informacion del producto"><img src="images/g3.png" class="img-responsive" alt=""/></a>
							<div class="gallery-text simpleCart_shelfItem">
							<h5><a class="name" href="producto.php"> no </a></h5>
									<p><span class="item_price"><?php echo $row['Precio'] ?></span></p>
								<h4 class="sizes">Sizes: <a href="#"> s</a> - <a href="#">m</a> - <a href="#">l</a> - <a href="#">xl</a> </h4>
								<ul>
									<li><a href="producto.php" title="Informacion del producto"><span class="glyphicon glyphicon-globe" aria-hidden="true"></span></a></li>
				...
				?>
						<div class="col-md-3 gallery-grid wow flipInY animated" data-wow-delay=".5s">
							<a href="producto.php" title="Informacion del producto"><img src="images/g3.png" class="img-responsive" alt=""/></a>
							<div class="gallery-text simpleCart_shelfItem">
							<h5><a class="name" href="producto.php">si </a></h5>
									<p><span class="item_price"><?php echo $row['Precio'] ?></span></p>
								<h4 class="sizes">Sizes: <a href="#"> s</a> - <a href="#">m</a> - <a href="#">l</a> - <a href="#">xl</a> </h4>
								<ul>
									<li><a href="producto.php" title="Informacion del producto"><span class="glyphicon glyphicon-globe" aria-hidden="true"></span></a></li>
        ...
        ?>
          <div class="col-md-3 gallery-grid gallery-grid2 wow flipInY animated" data-wow-delay=".9s">
            <a href="producto.php?modulo=producto&Id=<?php echo $row['Id'] ?>"><?php echo "<img src='upload/" . $row['imagen'] . "' class='img-responsive' alt=''>" ?></a>
            <div class="gallery-text simpleCart_shelfItem">
              <h5><a class="name" href="producto.php"> <?php echo $row['nombre'] ?> </a></h5>
              <p><span class="item_price"><?php echo $row['precio'] ?></span></p>
              <h4 class="sizes">Sizes: <a href="#"> s</a> - <a href="#">m</a> - <a href="#">l</a> - <a href="#">xl</a> </h4>
              <ul>
                <li><a href="productos.php"><span class="glyphicon glyphicon-globe" aria-hidden="true"></span></a></li>
    ...
    <div class="container">
      <div class="footer-info">
        ...
        <div class="col-md-4 footer-grids wow fadeInUp animated" data-wow-delay=".7s">
          ...
          <ul>
            <li><a href="acercadenosotros.php" style="color: white"><strong>Acerca de Nosotros</strong></a></li>

            <li><a href="contactanos.php" style="color: white;"><strong>Contáctanos</strong></a></li>
            <li><a href="preguntas.php" style="color: white"><strong>Preguntas Frecuentes</strong></a></li>
