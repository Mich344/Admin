...
<body>
	...
	<div class="container">
		...
		$query1 = "SELECT * FROM productos WHERE descripcion LIKE '%manga corta%' AND descripcion LIKE '%unisex%' OR descripcion LIKE '%manga corta%' AND descripcion LIKE '%mujer%';";
