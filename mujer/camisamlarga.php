...
<body>
	...
	<div class="container">
		...
		$query1 = "SELECT * FROM productos WHERE descripcion LIKE '%manga larga%' AND descripcion LIKE '%unisex%' OR descripcion LIKE '%manga larga%' AND descripcion LIKE '%mujer%';";
		...
		?>
		  <div class="col-md-3 gallery-grid gallery-grid2 wow flipInY animated" data-wow-delay=".9s">
		    <a href="single.php?modulo=single&Id=<?php $row['Id'] ?>"><?php echo "<img src='../upload/" . $row['imagen'] . "' class='img-responsive' alt=''>" ?></a>
