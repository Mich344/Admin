                     ...
                     <?php 
                        ...
                        if ($row['estado'] == 1) {
                          ?>
                              ...
                              ?>
                       <td>
                          <a href="Panel.php?modulo=EditarU&Id= <?php echo $row['Id'] ?> " style="margin: 8px "><i class="fas fa-user-edit" title="Editar Usuario"></i></a>

                          <a href="Panel.php?modulo=Usuarios&IdEstado1= <?php echo $row['Id'] ?> " class="btn btn-md" style="color:green;"> <i class="fas fa-user-plus" aria-hidden="true" title="Activo"></i></a>

                          <a href="Panel.php?modulo=Usuarios&IdEstado2= <?php echo $row['Id'] ?> " class="btn btn-md" style="color:red;"><i class="fas fa-user-minus" aria-hidden="true" title="Inactivo"></i></a>

                          <a href="Panel.php?modulo=Usuarios&IdBorrar= <?php echo $row['Id'] ?> " class="text-danger borrar"><i class="fas fa-trash-alt" title="Eliminar"></i></a>
                      </td>
                    </tr>
                  <?php
                  }
