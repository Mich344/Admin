            ...
            <div class="card-body">
              <form action="Panel.php?modulo=CrearU" method="post">
                ...
                <div class="for-group">
                  ...
                  <input type="password" name="pasword" class="form-control" minlength="5" maxlength="20" required="">
                </div>
                <div class="for-group">
                  <label>Ciudad</label>
                ...
                <div class="for-group">
                  ...
                  <input type="text" name="direccion" class="form-control" required="" minlength="6">
                </div>
                <div class="for-group">
