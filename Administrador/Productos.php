                     ...
                     <?php 
                        ...
                        if ($row['estado'] == 1) {
                          ?>
                              ...
                              ?>
                       <td>
                            <a href="Panel.php?modulo=EditarP&Id= <?php echo $row['Id'] ?> " style="margin: 8px; color:#0092F1 "><i class="fas fa-pencil-alt" title="Editar Usuario"></i></a>
                            ...
                            <a href="Panel.php?modulo=Productos&IdBorrar= <?php echo $row['Id'] ?> " class="btn btn-md" style="color:red;"><i class="fas fa-trash-alt" title="Eliminar"></i></a>
                      </td>
                    </tr>
                  <?php
                  }
