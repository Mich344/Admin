          ...
          <div class="card">
            ...
            <div class="card-body">
              <form action="Panel.php?modulo=Crearproveedor" method="post">
                ...
                <div class="for-group">
                  <label>Nombres</label>
                  <input type="text" name="nombreproveedor" class="form-control" pattern="[a-zA-Z]+" required="">
                </div>
                <div class="for-group">
                  <label>Apellidos</label>
                  <input type="text" name="apellidoproveedor" class="form-control" pattern="[a-zA-Z]+" required="">
                </div>
                <div class="for-group">
                  <label>Correo</label>
                ...
                <div class="for-group">
                  ...
                  <input type="password" name="paswordproveedor" class="form-control" minlength="5" maxlength="20" required="">
                </div>
                <div class="for-group">
                  <label>Ciudad</label>
                ...
                <div class="for-group">
                  ...
                  <input type="text" name="direccionproveedor" class="form-control" required="" minlength="6">
                </div>
                <div class="for-group">
