            ...
            <div class="card-body">
              <form action="Panel.php?modulo=Editarempleado" method="post">
                ...
                <div class="for-group">
                  ...
                  <select type="text" name="deparempleado" class="form-control" value="<?php echo $row['deparempleado'] ?>">
                ...
                <div class="for-group">
                  ...
                  <input type="text" name="direccionempleado" class="form-control" required="" value="<?php echo $row['direccionempleado'] ?>">
                </div>
                <div class="for-group">
                  <label>Telefono</label>
                  <input type="tel" name="telefonoempleado" class="form-control" required="" value="<?php echo $row['telefonoempleado'] ?>">
                </div>
                <div class="for-group">
