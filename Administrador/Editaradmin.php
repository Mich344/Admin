            ...
            <div class="card-body">
              <form action="Panel.php?modulo=Editaradmin" method="post">
                ...
                <div class="for-group">
                  ...
                  <select type="text" name="deparadmin" class="form-control" value="<?php echo $row['deparadmin'] ?>">
                    <option value="">-</option>
                ...
                <div class="for-group">
                  ...
                  <input type="text" name="direccionadmin" class="form-control" value="<?php echo $row['direccionadmin'] ?>">
                </div>
                <div class="for-group">
                  <label>Telefono</label>
                  <input type="tel" name="telefonoadmin" class="form-control" value="<?php echo $row['telefonoadmin'] ?>">
                </div>
                <div class="for-group">
