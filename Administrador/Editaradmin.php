            ...
            <div class="card-body">
              <form action="Panel.php?modulo=Editaradmin" method="post">
                ...
                <div class="for-group">
                  ...
                  <input type="password" name="paswordadmin" class="form-control" minlength="5" maxlength="20" required="" value="<?php echo $row['paswordadmin'] ?>">
                </div>
                <div class="for-group">
                ...
                <div class="for-group">
                  ...
                  <input type="text" name="direccionadmin" class="form-control" required="" value="<?php echo $row['direccionadmin'] ?>">
                </div>
                <div class="for-group">
                  <label>Telefono</label>
                  <input type="tel" name="telefonoadmin" class="form-control" required="" pattern="[0-9]+" value="<?php echo $row['telefonoadmin'] ?>">
                </div>
                <div class="for-group">
                  <label>Tipo Documento</label>
                  <input type="text" name="tip_docadmin" class="form-control" disabled required="" value="<?php echo $row['tip_docadmin'] ?>">
                </div>
                <div class="for-group">
