            ...
            <div class="card-body">
              <form action="Panel.php?modulo=EditarU" method="post">
                ...
                <div class="for-group">
                  ...
                  <input type="text" name="direccion" class="form-control" required="" value="<?php echo $row['direccion'] ?>">
                </div>
                <div class="for-group">
                  <label>Telefono</label>
                  <input type="tel" name="telefono" class="form-control" required="" pattern="[0-9]+" value="<?php echo $row['telefono'] ?>">
                </div>
                <div class="for-group">
