          ...
          <div class="card">
            ...
            <div class="card-body">
              <form action="Panel.php?modulo=EditarU" method="post">
                ...
                <div class="for-group">
                  <label>Nombre</label>
                  <input type="text" name="nombre" class="form-control" pattern="[a-zA-Z]+" required="" value="<?php echo $row['nombre'] ?>">
                </div>
                <div class="for-group">
                  <label>Apellido</label>
                  <input type="text" name="apellido" class="form-control" pattern="[a-zA-Z]+" required="" value="<?php echo $row['apellido'] ?>">
                </div>
                <div class="for-group">
                  <label>Email</label>
                ...
                <div class="for-group">
                  ...
                  <input type="password" name="pasword" class="form-control" minlength="5" maxlength="20" required="" value="<?php echo $row['pasword'] ?>">
                </div>
                <div class="for-group">
                  <label>Ciudad</label>
                ...
                <div class="for-group">
                  ...
                  <select type="text" name="depar" class="form-control" value="<?php echo $row['departamento'] ?>">
                    <option value="">-</option>
                ...
                <div class="for-group">
                  ...
                  <select type="text" name="tip_doc" class="form-control" value="<?php echo $row['tip_doc'] ?>">
                  <label>Tipo Documento</label>
                    <option value="">-</option>
                ...
                <div class="for-group">
                  ...
                  <input type="text" name="num_doc" class="form-control" value="<?php echo $row['num_doc'] ?>">
                </div>
                <div class="for-group">
                  <label>Fecha Nacimiento</label>
                  <input type="date" name="fech_nac" class="form-control" value="<?php echo $row['fech_nac'] ?>">
                </div>
                <div class="for-group">
                  <br>
