...
<body>
	...
	<div class="container">
		...
		$query1 = "SELECT * FROM productos WHERE descripcion LIKE '%marga larga%' AND descripcion LIKE '%unisex%' OR descripcion LIKE '%manga larga%' AND descripcion LIKE '%hombre%';";
