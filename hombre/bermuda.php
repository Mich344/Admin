...
<body>
		...
		<div class="top-header navbar navbar-default"><!--header-one-->
			...
			<div class="container">				
				<div class="nav navbar-nav wow fadeInLeft animated" data-wow-delay=".5s">
					<p><strong> <a href="../index1.php" style = "color: #B2051F ">SPORTS</a>WEARLINE</strong>|<a href="../register.php"><strong>Registrarse</strong> </a> O <a href="../signin.php"><strong>Ingresar </strong></a></p>
				</div>
								...
								<div class="row">
										<div class="col-sm-4 menu-grids menulist1">
											...
											<ul class="multi-column-dropdown ">
												<li><a class="list" href="../mujer/camisamlarga.php
												"><b>Manga larga</b></a></li>
												<li><a class="list" href="../mujer/camisamcorta.php
												"><b>Manga corta</b></a></li>
												<li><a class="list" href="../mujer/sinmanga.php
												"><b>Sin mangas</b></a></li>
										...
										<div class="col-sm-2 menu-grids">
											...
											<ul class="multi-column-dropdown">
												<li><a class="list" href="../mujer/pantalonesm.php
												"><b>Pantalones</b></a></li>	
												<li><a class="list" href="../mujer/shorts.php
												"><b>Shorts</b></a></li>
								...
								<ul class="dropdown-menu multi-column multi-column2">
									<div class="row">
										<div class="col-sm-3 menu-grids">
											<h4>Prendas superiores</h4>
											<ul class="multi-column-dropdown">
												<li><a class="list" href="../hombre/camisamg.php
												"><b>Manga larga</b></a></li>
												<li><a class="list" href="../hombre/camisamc.php
												"><b>Manga corta</b></a></li>
												<li><a class="list" href="../hombre/camisasm.php
												"><b>Sin mangas</b></a></li>
										...
										<div class="col-sm-3 menu-grids">
											<h4>Prendas inferiores</h4>
											<ul class="multi-column-dropdown">
												<li><a class="list" href="../hombre/sudadera.php
												"><b>Pantalones</b></a></li>
	...
	<div class="container">
		...
		$query1 = "SELECT * FROM productos WHERE descripcion LIKE '%bermuda%' AND descripcion LIKE '%unisex%' OR descripcion LIKE '%bermuda%' AND descripcion LIKE '%hombre%';";
