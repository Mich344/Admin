...
<body>
		...
		<div class="top-header navbar navbar-default"><!--header-one-->
			...
			<div class="container">				
				<div class="nav navbar-nav wow fadeInLeft animated" data-wow-delay=".5s">
					<p><strong> <a href="../index1.phphtml" style = "color: #B2051F ">SPORTS</a>WEARLINE</strong>|<a href="../register.php"><strong>Registrarse</strong> </a> O <a href="../signin.php"><strong>Ingresar </strong></a></p>
				</div>
		...
		<div class="header-two navbar navbar-default"><!--header-two-->
			<div class="container">
				...
				<div class="nav navbar-nav logo wow zoomIn animated" data-wow-delay=".7s">
					<h1><a href="../index1.phphtml" style="color: #B2051F">SPORTS<b>WEARLINE</b><span class="tag"><strong> Vístete bien, hoy tienes una cita con el deporte ¡Marca tú estilo!</strong></span></a></h1>
				</div>
	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				<li><a href="../index1.phphtml"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Inicio</a></li>
	...
	<div class="container">
		...
		$query1 = "SELECT * FROM productos WHERE descripcion LIKE '%botella%'";
		...
		<div class="container">
			<div class="footer-info">
				<div class="col-md-4 footer-grids wow fadeInUp animated" data-wow-delay=".5s">
					<h4 class="footer-logo"><a href="../index1.phphtml" style = "color: #B2051F">SPORTS <b style = "color: white">WEARLINE</b> <span class="tag"> </span> </a></h4>
